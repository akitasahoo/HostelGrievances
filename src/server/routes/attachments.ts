...
attachmentRoutes.get('/:id', (c) => {
	...
	c.header('Content-Security-Policy', "default-src 'none'; sandbox; script-src 'none'; object-src 'none';");
	c.header('Cache-Control', 'private, no-store, no-transform, must-revalidate');
